...
public class ActivityProducto3 extends AppCompatActivity implements ActivityProductoMVP.View{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridView = (GridView) findViewById(R.id.gridviewProducto3);
    ...
    public void getImagen(){
        ...
        gridViewImagenList.add(new GridViewImagen(" ", R.drawable.bal1));
        gridViewImagenList.add(new GridViewImagen(" ", R.drawable.bal2));
        gridViewImagenList.add(new GridViewImagen(" ", R.drawable.bal3));
        gridViewImagenList.add(new GridViewImagen(" ", R.drawable.bal15));
        gridViewImagenList.add(new GridViewImagen(" ", R.drawable.bal16));
